 ...
 * @author Nick
 */
@WebServlet(name = "ControllerHW", urlPatterns = {"/controllerHW"})
public class ControllerHW extends HttpServlet {

    private static final String DESTINATION = "labHW.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CalculateServiceHW cs = new CalculateServiceHW();
        String area = "";
